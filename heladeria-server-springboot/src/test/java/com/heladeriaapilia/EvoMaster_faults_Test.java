...
/**
 * This file was automatically generated by EvoMaster on 2022-06-11T14:45:19.233-03:00[America/Argentina/Buenos_Aires]
 * <br>
    ...
    */
    ...
    public void test_0_with500() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("application/json")
                ...
                .body(" { " + 
                    ...
                    " \"peso\": \"EVOMASTER\" " + 
                    " } ")
                .post(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/23/potes")
                .then()
                .statusCode(500)
                .assertThat()
                .contentType("application/json")
                ...
                .body("'path'", containsString("/guidodecaso/heladeria/1.0.0/pedidos/23/potes"));
    ...
    public void test_1() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                .get(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/906/pago")
                .then()
                .statusCode(501)
                .assertThat()
                .body(isEmptyOrNullString());
    ...
    public void test_3() throws Exception {
        ...
        given().accept("*/*")
                .get(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/973/potes")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
        ...
        given().accept("*/*")
                .delete(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/833/potes/300")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/7/potes")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
        ...
        given().accept("application/json")
                ...
                .assertThat()
                .contentType("application/json")
                .body("'direccion_entrega'", containsString("jRuBP5jf6s"))
    ...
    public void test_10() throws Exception {
        ...
        given().accept("*/*")
                ...
                .body(" { " + 
                    ...
                    " \"peso\": \"EVOMASTER\" " + 
                    " } ")
                .post(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/575/potes")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
    ...
    public void test_12() throws Exception {
        ...
        given().accept("*/*")
                .contentType("application/json")
                .body(" { " + 
                    " \"direccion_entrega\": \"KI6tO0L4\" " + 
                    " } ")
                .put(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/554")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
    ...
    public void test_13() throws Exception {
        ...
        given().accept("*/*")
                .get(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/gustos/z8qemUWft889OZcW")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
        ...
        ValidatableResponse res_1 = given().accept("*/*")
                .contentType("application/json")
                .body(" { " + 
                    " \"tipoDePago\": \"RAehaVZ7R\" " + 
                    " } ")
                .post(baseUrlOfSut + "/guidodecaso/heladeria/1.0.0/pedidos/631/pagar")
                .then()
                .statusCode(400)
                .assertThat()
                .body(isEmptyOrNullString());
        ...
        expectationHandler.expect(ems)
            .that(sco, Arrays.asList(200, 201, 202, 401, 403, 404).contains(res_1.extract().statusCode()));
    }
