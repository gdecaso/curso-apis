...
public class PedidosPedidoIdBody   {
  @JsonProperty("direccion_entrega")
  private String direccionEntrega = null;

  public PedidosPedidoIdBody direccionEntrega(String direccionEntrega) {
  ...
  public boolean equals(Object o) {
    ...
    PedidosPedidoIdBody pedidosPedidoIdBody = (PedidosPedidoIdBody) o;
    return Objects.equals(this.direccionEntrega, pedidosPedidoIdBody.direccionEntrega);
  }
  ...
  public String toString() {
    ...
    sb.append("class PedidosPedidoIdBody {\n");
